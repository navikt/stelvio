...
private SSLConfig sslConfig;
     ...
     * 
     * @param jsfPages the JSF pages with the page name as key.
     */
    ...
    /**
     * Sets the object that contains the SSL configuration
     * for the overall application: https port, http port
     * and keep-ssl-mode
     * 
     * @param sslConfig the overall SSL configuration information.
     */
    ...
    /**
     * Gets the <code>SSLConfig</code> object.
     * If the object is <code>null</code> it will be created with default settings.
     ...
     * @param jsfPage the JSF page to add.
     */
    ...
    /**
     * Checks if SSL mode should be kept even when accessing pages not requiring SSL.
     * @return <code>true</code> if SSL mode should be kept after enabled, <code>false</code> otherwise. 
     */
     ...
     * @param viewId - the ViewId value obtained in the JSF view handler
