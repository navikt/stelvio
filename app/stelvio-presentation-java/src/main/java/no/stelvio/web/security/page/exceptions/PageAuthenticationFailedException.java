...
public class PageAuthenticationFailedException extends SecurityException {
	...
	/**
	 * Constructor to set the root cause if an exception caused the authentication to fail. 
	 * Other parameters: the viewId and the page requirements of the page 
	 * which the user tried to access. 
	 * @param t root cause of the error.
	 * @param viewId the viewId.
	 * @param page the JSFPage object containing the security requirements of the page.
	 */
	public PageAuthenticationFailedException(Throwable t,String viewId, JSFPage page){
		super(t,viewId);
		pageRequirements = page;
	}
