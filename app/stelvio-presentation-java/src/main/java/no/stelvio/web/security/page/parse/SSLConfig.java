...
/**
 * Object to hold the SSL port and SSL definitions defined in the
...
public class SSLConfig {
    ...
    /**
     * Once a page is accessed in SSL mode, developers may decide that 
     * from here on all other pages must be accessed with SSL as well.
     * 
     * @param keepSslMode - default value is false. Set to true if you want
     * to continue with SSL. If set to false SSL mode is looked up in the 
     * page definition and SSL might be switched back to normal http.
     */
