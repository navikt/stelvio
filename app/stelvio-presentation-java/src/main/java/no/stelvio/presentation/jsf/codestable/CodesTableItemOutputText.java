 ...
 * <li><code>codeValue</code> the code value of the component, which will translated into a decode value. The decode value
 * will be set as the value on the super class.</li>
 * </ul>
 * 
...
public class CodesTableItemOutputText extends HtmlOutputText {
	...
	public String getCodeValue() {
		if (getValueBinding(ATTRIBUTE_CODE_VALUE) != null) {
			codeValue = (String) getValueBinding(ATTRIBUTE_CODE_VALUE).getValue(FacesContext.getCurrentInstance());
		}
		return codeValue;
	}
