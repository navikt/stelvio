...
public class HtmlMenuExtendedRenderer extends HtmlMenuRenderer {
	...
	/**
	 * Internal render select.
	 * 
	 * @param facesContext context
	 * @param uiComponent component
	 * @param disabled disabled
	 * @param size size
	 * @param selectMany select many
	 * @throws IOException ioexception
	 */
	 ...
	 * @param lookupSet lookup set
	 * @param selectItemList select item list
	 * @throws IOException ioexception
	 */
