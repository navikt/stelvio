...
/**
 * This class parses and reads in all the &lt;security-role> elements from web.xml 
 * and stores the roles in a <code>WebAppRoles</code> object. The parsing of the file is done using
...
public class WebXmlParser {
	 ...
	 * @param url the url of the web.xml file
	 * @throws IOException from the digester
	 * @throws SAXException from the digester
	 */
	 ...
	 * @param d the digester to use
	 * @param url the url of the web.xml file
	 * @return a WebAppRoles objecy containing a collection of security roles
	 * @throws IOException from the digester
	 * @throws SAXException from the digester
	 */
	private WebAppRoles parseWebXml(Digester d, URL url)
