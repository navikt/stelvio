...
public class JsfPage {
	 ...
	 * 
	 * @param requiresAuthentication
	 *            wheter or not the page requires authentication. Should be
	 *            "true" or "false".
	 */
	public void setRequiresAuthentication(String requiresAuthentication) {
		this.requiresAuthentication = new Boolean(requiresAuthentication)
				.booleanValue();
	}
	 ...
	 * 
	 * @return <code>true</code> if page requires authentication,
	...
	/**
	 * Sets the page to require authorization with boolean parameter. If set to
	 * <code>true</code>, the page will also be set to require
	 * authentication.
	 * 
	...
	/**
	 * Sets the page to require authorization with string parameter. If set to
	 * "true", the page will also be set to require authentication.
	 * 
	 * @param requiresAuthorization
	 *            wheter or not the page requires authorization. Should be
	 *            "true" or "false";
	 */
	public void setRequiresAuthorization(String requiresAuthorization) {
		this.requiresAuthorization = new Boolean(requiresAuthorization)
				.booleanValue();
		// authorization is based on authentication
		if (this.requiresAuthorization) {
			setRequiresAuthentication(this.requiresAuthorization);
	 ...
	 * 
	 * @return <code>true</code> if page requires authorization,
	 *         <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @param requiresSSL
	 *            wheter or not the page requires SSL. Should be "true" or
	 *            "false".
	 */
	 ...
	 * 
	 * @return <code>true</code> if page requires SSL, <code>false</code>
	 *         otherwise.
	 */
	 ...
	 */
	public JeeRoles getRoles() {
		if (this.roles == null) {
			this.roles = new JeeRoles();
		}
		return this.roles;
	}

	/**
	 * Sets how the J2EE roles should be treated when evaluating this page, i.e.
	 * if it is required to have all roles or just one to access the page.
	 * 
	...
	/**
	 * Gets how the J2EE roles should be treated when evaluating this page, i.e.
	 * if it is required to have all roles or just one to access the page.
	 * 
	...
	public String toString() {
		...
		sb.append(",Requires authentication=").append(
				this.requiresAuthentication);
		sb.append(",Requires authorization=")
				.append(this.requiresAuthorization);
