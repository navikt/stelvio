 ...
 * decision based on the roles found in the Roles annotation for the current intercepted method. If no such annotation
 * is found the class simply abstains from voting, i.e its vote method returns
 * <code>AccessDecisionVoter.ACCESS_ABSTAIN</code>.  
 * 
...
public class RoleAccessDecisionVoter implements AccessDecisionVoter {
	 ...
	 * obtained from the intercepted method's Roles annotation. If no such annotation is present
	 * AccessDecisionVoter.ACCESS_ABSTAIN will be returned.
	 * 
	 ...
	 * @return AccessDecisionVoter.ACCESS_GRANTED, AccessDecisionVoter.ACCESS_DENIED or
