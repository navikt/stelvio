...
/**
 * Exception thrown if creating an <code>AfterInvocationProvider</code> 
 * from a configuration attribute fails.
 * 
...
public class AfterInvocationProviderNotFoundException extends SecurityException {
	 ...
	 * @param name the class name of the AfterInvocationProvider.
	 * @param reason the reason for this exception to be thrown.
	 */
	 ...
	 * @param reason the reason for this exception to be thrown
	 */
	public AfterInvocationProviderNotFoundException(Throwable cause, String name, String reason){
