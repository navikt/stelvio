...
/**
 * Class used to validate BBAN 
 * (Basic Bank Account Number: used by financial institutions in individual countries as part of a National Account Numbering Scheme which uniquely identifies an account of a customer at a financial institution.)
...
public class BbanValidator {
	 ...
	 * @param norwegianBban a Norwegian Bank account number, either human readable (with spaces) or computer readable (witout spaces)
     ...
     *
     * @param inputString String to validate, max length 25.
