...
public class SecurityContextSetter {
	...
	public static void setSecurityContext(SecurityContext securityContext) {
		if (setSecurityContextMethod == null){
			setSecurityContextMethod = ReflectionUtils.findMethod(SecurityContextHolder.class, 
					"setSecurityContext", new Class[]{SecurityContext.class});
	 ...
	 * @param roles a list of rolenames.
	 */
	...
	public static void resetSecurityContext(){
		if (resetSecurityContextMethod == null){
			resetSecurityContextMethod = 
				ReflectionUtils.findMethod(SecurityContextHolder.class, "resetSecurityContext", new Class[]{});
