...
/**
 * Interface defining functionality for retrieving a codetable's item or an items decode, in addition - for adding
 * predicates to filer the items in the codestable.
 *
...
public interface CodesTable<T extends CodesTableItem> extends Serializable {
	 ...
	 * @return The <code>CodesTableItem</code> or <code>null</code> if the code does not exist in the
