...
/**
 * Exception thrown if the attribute of a <code>Secured</code> annotation is not
 * present in a <code>AnnotationAttributesMapping</code>.
 * 
...
public class SecureAnnotationNotInMappingException extends SecurityException {
	 ...
	 */
	public SecureAnnotationNotInMappingException(Secured annotation, Class annotatedClass){
	 ...
	 */
	public SecureAnnotationNotInMappingException(Secured annotation, Method annotatedMethod){
