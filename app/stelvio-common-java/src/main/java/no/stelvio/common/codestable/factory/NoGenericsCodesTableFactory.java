 ...
 * @deprecated Use {@link no.stelvio.common.codestable.factory.NoGenericsCodesTableItemsFactory} instead.
 */
@Deprecated
public interface NoGenericsCodesTableFactory {
	 ...
	 */
	Object createCodesTable(Class codesTableItemClass) throws CodesTableNotFoundException;

	/**
	 * Retrieves an instance of CodesTablePeriodic.
	 *
	 * @param codesTableItemPeriodicClass
	 * @return object reference to a CodesTablePeriodic
	 * @throws CodesTableNotFoundException if codestable wasn't found in underlying persistence store
	 */
	Object createCodesTablePeriodic(Class codesTableItemPeriodicClass) throws CodesTableNotFoundException;	
}
