...
import no.stelvio.common.validation.IbanValidator;
import junit.framework.TestCase;

public class TestIbanValidator extends TestCase {

	/**
	 * Checks that valid Iban passes the validation check
	 * Paper iban is an Iban with added spaces to be easier to read for humans
	 * Electronic iban is an iban without spaces, optimized for computers
	 */
