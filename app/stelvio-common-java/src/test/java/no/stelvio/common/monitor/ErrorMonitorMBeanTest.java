...
import no.stelvio.common.monitor.ErrorMonitorReportReceiver;
import no.stelvio.common.monitor.ErrorReport;
...
public class ErrorMonitorMBeanTest extends TestCase {
	...
	public void testInit() {
		try {
			...
			assertEquals("Test 2", "no.stelvio.common.monitor.ErrorMonitorReportReceiver", info.getClassName());
