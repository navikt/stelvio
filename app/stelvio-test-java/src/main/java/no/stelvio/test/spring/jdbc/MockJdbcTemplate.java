...
public class MockJdbcTemplate extends JdbcTemplate { //implements Verifiable, BuilderNamespace {
    ...
    /**
     * Sets the expected number of times a method should be called. Use the returned value 
     * to set the expected method.
     *
	 ...
	 * @throws DataAccessException if there is any problem issuing an update
	 ...
	 * @param obj the object to compare with this objects JdbcTemplate
	 ...
	 * @param action calback object that specifies the action
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#execute(java.lang.String, org.springframework.jdbc.core.PreparedStatementCallback)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#execute(org.springframework.jdbc.core.CallableStatementCreator, org.springframework.jdbc.core.CallableStatementCallback)<code>
	...
	/** 
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#execute(org.springframework.jdbc.core.PreparedStatementCreator, org.springframework.jdbc.core.PreparedStatementCallback)<code>
	 ...
	 * @param psc object that can create a PreparedStatment given a connection
	 * @param action callback object that specifies the action
	 * @return a result object returned by the action or null
	 * @throws DataAccessException if there is any problem
	 */
	...
	/** 
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#execute(org.springframework.jdbc.core.StatementCallback)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, java.lang.Object[], int[], org.springframework.jdbc.core.ResultSetExtractor)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, java.lang.Object[], int[], org.springframework.jdbc.core.RowCallbackHandler)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, java.lang.Object[], int[], org.springframework.jdbc.core.RowMapper)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, java.lang.Object[], org.springframework.jdbc.core.ResultSetExtractor)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, java.lang.Object[], org.springframework.jdbc.core.RowCallbackHandler)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, java.lang.Object[], org.springframework.jdbc.core.RowMapper)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, org.springframework.jdbc.core.PreparedStatementSetter, org.springframework.jdbc.core.ResultSetExtractor)<code>
	 ...
	 * @param sql - SQL query to execute
     * @param pss - object that knows how to set values on the prepared statement. If this is null, the SQL will be assumed to contain no bind parameters. 
     * Even if there are no bind parameters, this object may be used to set fetch size and other performance options.
     * @param rse - object that will extract results
     * @throws DataAccessException if the query fails
     * @return an arbitrary result object, as returned by the ResultSetExtractor 
	 */
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, org.springframework.jdbc.core.PreparedStatementSetter, org.springframework.jdbc.core.RowCallbackHandler)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, org.springframework.jdbc.core.PreparedStatementSetter, org.springframework.jdbc.core.RowMapper)<code>
	 ...
	 * @param sql - SQL query to execute
	 * @param pss - object that knows how to set values on the prepared statement. If this is null, the SQL will be assumed to contain no bind 
	 * 	parameters. Even if there are no bind parameters, this object may be used to set fetch size and other performance options.
     * @param rowMapper - object that will map one object per row
     * @throws DataAccessException if the query fails
     * @return the result List, containing mapped objects
	 */
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, org.springframework.jdbc.core.ResultSetExtractor)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, org.springframework.jdbc.core.RowCallbackHandler)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(java.lang.String, org.springframework.jdbc.core.RowMapper)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(org.springframework.jdbc.core.PreparedStatementCreator, org.springframework.jdbc.core.ResultSetExtractor)<code>
     ...
     * @throws DataAccessException if the query fails
     * @param creator - object that can create a PreparedStatement given a Connection
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(org.springframework.jdbc.core.PreparedStatementCreator, org.springframework.jdbc.core.RowCallbackHandler)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#query(org.springframework.jdbc.core.PreparedStatementCreator, org.springframework.jdbc.core.RowMapper)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#queryForInt(java.lang.String, java.lang.Object[])<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#queryForList(java.lang.String, java.lang.Object[])<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#queryForLong(java.lang.String, java.lang.Object[])<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#queryForObject(java.lang.String, java.lang.Class)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#queryForObject(java.lang.String, java.lang.Object[], java.lang.Class)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.support.JdbcAccessor#setExceptionTranslator(org.springframework.jdbc.support.SQLExceptionTranslator)<code>
	 ...
	 * @param et the SQLExceptionTranslator to set
	 */
	 ...
	 * @param ignore the value to set for ignore warnings
	 */
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#setNativeJdbcExtractor(org.springframework.jdbc.support.nativejdbc.NativeJdbcExtractor)<code>
	 ...
	 * @param nje the NativeJdbcExtractor to set
	 */
	 ...
	 * @return String representing the proxyJdbcTemplate
	 */
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#update(java.lang.String, java.lang.Object[], int[])<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#update(java.lang.String, org.springframework.jdbc.core.PreparedStatementSetter)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#update(org.springframework.jdbc.core.PreparedStatementCreator)<code>
	...
	/**
	 * Mocks the call to <code>org.springframework.jdbc.core.JdbcTemplate#update(org.springframework.jdbc.core.PreparedStatementCreator, org.springframework.jdbc.support.KeyHolder)<code>
