...
/**
 * Utility class intended to be used in testing which via reflection can set 
 * the RequestContext and SecurityContext on the current thread.
 * 
...
public class StelvioContextSetter {
	 ...
	 */
	public static final void setSecurityContext(SecurityContext securityContext) {
	 ...
	 */
	public static final void setSecurityContext(String userId, String... roles) {
	 ...
	 */
	public static final void resetRequestContext(){
	 ...
	 */
	public static final void resetSecurityContext(){
