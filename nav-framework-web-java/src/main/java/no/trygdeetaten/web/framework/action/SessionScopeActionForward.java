 ...
 * 		...
 * 		<forward name="OppretteOppgave" path="/Oppgave.do" className="no.trygdeetaten.web.framework.action.SessionScopeActionForward"/>
 * 		<forward name="ViseOppgave" path="/Oppgave.do" className="no.trygdeetaten.web.framework.action.SessionScopeActionForward"/>
 * 		<forward name="EndreOppgave" path="/Oppgave.do" className="no.trygdeetaten.web.framework.action.SessionScopeActionForward"/>
 * 		...
 * 	</action>
 * </pre>
 * 
