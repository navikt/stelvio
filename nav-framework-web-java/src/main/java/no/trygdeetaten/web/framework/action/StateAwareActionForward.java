 ...
 * 		...
 * 		<forward name="OppretteOppgave" path="/Oppgave.do" className="no.trygdeetaten.web.framework.action.StateAwareActionForward">
 * 			<set-property property="state" value="opprette"/>
 * 		</forward>
 * 		<forward name="ViseOppgave" path="/Oppgave.do" className="no.trygdeetaten.web.framework.action.StateAwareActionForward">
 * 			<set-property property="state" value="vise"/>
 * 		</forward>
 * 		<forward name="EndreOppgave" path="/Oppgave.do" className="no.trygdeetaten.web.framework.action.StateAwareActionForward">
