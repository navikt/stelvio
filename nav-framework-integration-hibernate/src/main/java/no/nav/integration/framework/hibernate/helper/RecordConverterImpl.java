...
import no.nav.integration.framework.hibernate.mapping.OneToOne;
...
public final class RecordConverterImpl implements BeanFactoryAware, RecordConverter {
	/** Logging */
	private static final Log LOG = LogFactory.getLog("no.nav.integration.framework.hibernate.helper.RecordConverter");
