...
import no.trygdeetaten.integration.framework.hibernate.mapping.Column;
import no.trygdeetaten.integration.framework.hibernate.mapping.OneToMany;
...
public class RecordHelperTest extends TestCase {
	...
	public void testGetOneToMany() {
		String role = "no.trygdeetaten.integration.framework.hibernate.records.Foreldre.barn";
	...
	public void testGetChildClass() {
		...
		assertEquals("no.trygdeetaten.integration.framework.hibernate.records.Barn", clazz);
	}
	...
	public void testGetRoleName() {
		...
		String solution = "no.trygdeetaten.integration.framework.hibernate.records.Foreldre.barn";
	...
	public void testGetRootClass() {
		...
		RootClass clazz = RecordHelper.getRootClass( config, "no.trygdeetaten.integration.framework.hibernate.records.Foreldre" );
