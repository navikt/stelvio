...
import no.nav.common.framework.util.ResourceLookupHelper;
...
public class ResourceLookupHelperTest extends TestCase {
	...
	public void testInitialContextConstructionAndLookupSuccessful() {
		System.setProperty("java.naming.factory.initial", "no.nav.common.framework.ejb.TestInitialContextFactory");
	...
	public void testInitialContextConstructionFailure() {
		System.setProperty(
			...
			"no.nav.common.framework.ejb.TestInitialContextFactoryCreationFailure");
		LookupHelper h = new ResourceLookupHelper();
		try {
	...
	public void testContextCloseFailure() {
		System.setProperty(
			"java.naming.factory.initial",
			"no.nav.common.framework.ejb.TestInitialContextFactoryCloseFailure");
		LookupHelper h = new ResourceLookupHelper();
