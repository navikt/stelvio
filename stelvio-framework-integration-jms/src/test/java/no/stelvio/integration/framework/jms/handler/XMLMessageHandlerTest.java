package no.stelvio.integration.framework.jms.handler;
...
import no.stelvio.integration.framework.jms.DummyTextMessage;
import no.stelvio.integration.framework.jms.handler.XMLMessageHandler;
...
public class XMLMessageHandlerTest extends TestCase {
	...
	public void testHandleMessage() {
		try {
			...
			classNames.put("testNestedField2", "no.stelvio.integration.framework.jms.handler.TestBean");
			...
			classNames.put("testHeaderField2", "no.stelvio.integration.framework.jms.handler.TestBean");
			...
			classNames.put("field1", "no.stelvio.integration.framework.jms.handler.TestBean");
			classNames.put("field2", "no.stelvio.integration.framework.jms.handler.TestBean");
			classNames.put("field3", "no.stelvio.integration.framework.jms.handler.TestBean");
			classNames.put("field4", "no.stelvio.integration.framework.jms.handler.TestBean");
			...
			classNames.put("field1[id]", "no.stelvio.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			...
			classNames = new HashMap();
			classNames.put("field1[c]", "no.stelvio.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("typedListBean[i]", "no.stelvio.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("interfaceListBean[i]", "no.stelvio.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("typedMapBean[i]", "no.stelvio.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("interfaceMapBean[i]", "no.stelvio.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
