...
<#macro ProcessingRule name direction actions>
	<#list actions as action>
	<#assign actionName="${name}_${direction}-${action.name}"/>
	<#--
	...
	-->
	<WSStylePolicyRule name="${name}_${direction}" xmlns:env="http://www.w3.org/2003/05/soap-envelope" xmlns:dp="http://www.datapower.com/schemas/management">
		...
		<#list actions as action>
		<Actions class="StylePolicyAction">${name}_${direction}-${action.name}</Actions>
		</#list>
	</WSStylePolicyRule>
</#macro>