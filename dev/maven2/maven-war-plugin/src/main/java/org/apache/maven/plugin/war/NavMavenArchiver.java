...
public class NavMavenArchiver extends MavenArchiver {
	...
	*/
	...
	protected Manifest getManifest( MavenProject project, ManifestConfiguration config, Map entries, List<ArtifactItem> classpathExcludes, List<String> customClasspathEntries ) throws ManifestException, DependencyResolutionRequiredException {
