...
public class TestCtpi extends CodesTablePeriodicItem<TestCtiCode, String> {
	...
	/**
	 * creates an ctpi with code EXISTS_1.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_2.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_3.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_4.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_NOT.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_DECODE.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_OVERLAP with overlapping dates.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code OVERLAP_WITH_NULL with overlapping dates, one is null.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code OVERLAP_WITH_NULL with overlapping dates.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_TIME_1.
	 * 
	 * @return ctpi
	 */
	...
	/**
	 * creates an ctpi with code EXISTS_TIME_2.
	 * 
	 * @return ctpi
	 */
