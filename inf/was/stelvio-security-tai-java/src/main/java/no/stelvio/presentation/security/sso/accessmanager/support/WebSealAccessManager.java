...
/**
 * A WebSEAL implementation of the StelvioAccessManager which <b>can</b> support a connection to a Tivoli Access Manager through
 * the AccessManagerConnector. If this connector is present the userprincipal representation must be of type <code>byte[]</code>
 * and the AccessManagerConnector must be able to transform this representation into a StelvioPrincipal. If no
 * AccessManagerConnector is present the userprincipal representation must be of type <code>StelvioPrincipal</code>.
 * 
...
public class WebSealAccessManager implements StelvioAccessManager {
     ...
     * 
     * @param accessManagerConnector
     *            the accessManagerConnector to set.
     */
