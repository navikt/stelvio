...
/**
 * Interface for a single-sign-on request handler which can determine whether the current request should be acted on and get the
 * representation of a userprincipal.
 * 
...
public interface SSORequestHandler {
    ...
    /**
     * Gets the representation of a userprincipal from the current request if such a representation is present.
     * 
     * @param request
     *            the current request
