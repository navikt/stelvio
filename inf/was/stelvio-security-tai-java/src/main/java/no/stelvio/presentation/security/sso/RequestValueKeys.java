...
public class RequestValueKeys {
	...
	/**
	 * @param authorizedAsKey the authorizedAsKey to set
	 */
	...
	/**
	 * @param accessManagerUserKey the accessManagerUserKey to set
	 */
	...
	/**
	 * @param authenticationLevelKey the authenticationLevelKey to set
	 */
	...
	/**
	 * @param autorizationTypeKey the autorizationTypeKey to set
	 */
	...
	/**
	 * @param originalUserNameKey the originalUserNameKey to set
	 */
