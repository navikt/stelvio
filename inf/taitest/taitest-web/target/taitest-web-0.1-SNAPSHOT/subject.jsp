...
//     subjectstring.append("<br>Public credential "  + i + " : "+ ((WSCredential) pubcreds.get(i)).getUniqueSecurityName());
//     subjectstring.append("<br>Roles "  + i + " : "+ ((WSCredential) pubcreds.get(i)).getRoles());
//     subjectstring.append("<br>Groups "  + i + " : "+ ((WSCredential) pubcreds.get(i)).getGroupIds());
