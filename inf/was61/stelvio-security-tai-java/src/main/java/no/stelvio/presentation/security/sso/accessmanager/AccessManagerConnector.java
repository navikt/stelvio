...
/**
 * Represents a connector to an external access-manager which in order to convert a principal 
 * representation must have a connection to decode it. 
 *
...
public interface AccessManagerConnector {
	 ...
	 * @param representation the representation to decode.
	 * @return the correponding StelvioPrincipal for the principal representation.
	 * @throws PrincipalNotValidException if the representation is not valid
	 */
