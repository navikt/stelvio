...
/**
 * A openAm implementation of the StelvioAccessManager
 * The userprincipal representation must be of type <code>StelvioPrincipal</code>.
 * 
...
public class OpenAmAccessManager implements StelvioAccessManager {
	 ...
	 * 
	 * @param openAMAddress the open AM address
	 */
	 ...
	 * 
	 * @param openAMQueryTemplate the open AM query template
	 */
	 ...
	 * 
	 * @param sessionId OpenAM sessionid from cookie
