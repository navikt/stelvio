...
/**
 * An implementation of a StelvioPrincipal containing only userid and authentication level
 * for a userprincipal. 
 * 
...
public class DefaultStelvioPrincipal implements StelvioPrincipal {
	 ...
	 *  
	 * @param userId the userid of the principal
	 * @param authLevel the authentication level for the principal
	 */
