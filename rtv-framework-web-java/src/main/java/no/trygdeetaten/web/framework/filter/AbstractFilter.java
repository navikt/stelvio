...
import no.trygdeetaten.common.framework.error.LoggableException;
...
public abstract class AbstractFilter implements Filter {
	 ...
	 *    <filter-class>no.trygdeetaten.web.framework.filter.TransactionContextFilter</filter-class>
	 *    <init-param>
