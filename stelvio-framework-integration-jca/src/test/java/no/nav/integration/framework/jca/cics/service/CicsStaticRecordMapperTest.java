package no.nav.integration.framework.jca.cics.service;
...
import no.nav.integration.framework.hibernate.records.Foreldre;
import no.nav.integration.framework.jca.cics.records.CICSGenericRecord;
import no.nav.integration.framework.jca.cics.service.CicsStaticRecordMapper;
