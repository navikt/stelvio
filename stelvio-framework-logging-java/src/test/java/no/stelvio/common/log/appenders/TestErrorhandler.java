...
public class TestErrorhandler extends FallbackErrorHandler {
	...
	/** 
	 * {@inheritDoc}
	 * @see org.apache.log4j.spi.ErrorHandler#error(java.lang.String, java.lang.Exception, int, org.apache.log4j.spi.LoggingEvent)
	 */
	 ...
	 * 
	 * @param string the test error string.
	 */
