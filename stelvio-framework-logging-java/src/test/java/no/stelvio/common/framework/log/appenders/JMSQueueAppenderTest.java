...
import no.stelvio.common.framework.log.appenders.JMSQueueAppender;
...
public class JMSQueueAppenderTest extends TestCase {
	...
	TestInitialContext ic = null;

	/**
	 * Constructor for JMSQueueAppenderTest.
	 * @param arg0
	 */
	public JMSQueueAppenderTest(String arg0) {
		super(arg0);
		TestInitialContextFactory fac = new TestInitialContextFactory();

		try {
			ic = (TestInitialContext) fac.getInitialContext(null);
	...
	public void testActivateOptions() {
		System.out.println("############## testActivateOptions ################");
		try {
			...
			assertEquals(
				"Test 1: Unexpected error message",
				"The binding name for a QueueConnectionFactory is missing for appender [TestJMSQueueAppender].",
			...
			assertEquals(
				"Test 2: Unexpected error message",
				"The binding name for a Queue is missing for appender [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertEquals(
				"Test 3: Unexpected error message",
				"Error while initializing JNDI context for appender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			appender.setInitialContextFactoryName("no.stelvio.common.framework.log.appenders.TestInitialContextFactory");
			...
			assertEquals(
				"Test 5: Unexpected error message",
				"Error while creating queue connection for appender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertEquals(
				"Test 6: Unexpected error message",
				"Error while creating queue session for appender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertEquals(
				"Test 7: Unexpected error message",
				"Error while creating queue sender for appender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertEquals(
				"Test 8: Unexpected error message",
				"Error while starting queue connection for appender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertEquals(
				"Test 9: Unexpected error message",
				"Error while closing JNDI context for appender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
	...
	public void testAppendLoggingEvent() {
		System.out.println("############## testAppendLoggingEvent ################");
		try {
			// test: entry conditions are not met. Error should occur
			appender.append(null);
			assertEquals("Test 1: Unexpected number of errors.", 1, handler.getNumErrors());
			assertEquals(
				"Test 1: Unexptected error message",
				"No QueueConnection for JMSQueueAppender named [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertEquals("Test 2: Unexpected number of errors.", 1, handler.getNumErrors());
			assertEquals(
				"Test 2: Unexptected error message",
				"Could not publish message in JMSAppender [TestJMSQueueAppender].",
				handler.getTestErrorString());
			handler.setNumErrors(0);
			...
			assertTrue("Test 3: Unexpected logging format", msg.getText().startsWith("ERROR - Test message :java.lang.Exception: Test"));
