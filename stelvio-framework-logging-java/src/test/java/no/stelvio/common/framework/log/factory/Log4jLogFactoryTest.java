package no.stelvio.common.framework.log.factory;
...
import no.stelvio.common.framework.log.factory.Log4jLogFactory;
...
public class Log4jLogFactoryTest extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		//System.setProperty("org.apache.commons.logging.LogFactory", "no.stelvio.common.framework.log.factory.Log4jLogFactory");
	...
	public void testRefresh() {
		...
		try {
			...
			assertEquals(
				...
				"ERROR, Console, TEST",
				prop.getProperty("log4j.logger.no.stelvio"));
