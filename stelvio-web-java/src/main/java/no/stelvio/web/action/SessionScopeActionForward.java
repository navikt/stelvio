 ...
 * 		...
 * 		<forward name="OppretteOppgave" path="/Oppgave.do" className="no.stelvio.web.action.SessionScopeActionForward"/>
 * 		<forward name="ViseOppgave" path="/Oppgave.do" className="no.stelvio.web.action.SessionScopeActionForward"/>
 * 		<forward name="EndreOppgave" path="/Oppgave.do" className="no.stelvio.web.action.SessionScopeActionForward"/>
 * 		...
 * 	</action>
 * </pre>
 * 
