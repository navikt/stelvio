...
public final class DateUtil {
     ...
     *
     * @param date Dato
     * @param years År fremover (positive tall) eller år bakover (negative tall)
     ...
     *
     * @param date Datoen
     * @param months Måneder fremover / bakover
     ...
     *
     * @param date Datoen
     * @return Første dagen i måneden etter datoen
     */
     ...
     * @param dateField hvilket felt som skal finnes (vil være feks Calendar.YEAR)
