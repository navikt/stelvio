package no.stelvio.framework.sso;
 ...
 * og sette ws.ext.dirs på serveren til å inkludere hvor denne filen ligger
 * (E:\data\workspace\head\stelvio-framework-sso-was\bin) og
 ...
 * @version $Id: stelvioTrustInterceptor.java 2654 2005-11-28 11:14:54Z shc2920 $
 * @deprecated bruk no.stelvio.framework.sso.NtlmTrustInterceptor istedenfor.
 */
public class StelvioTrustInterceptor
