...
import no.nav.common.framework.report.config.ReportChartType;
import no.nav.common.framework.report.design.chart.BarChartDataSetFactory;
import no.nav.common.framework.report.design.chart.PieChartDataSetFactory;
import no.nav.common.framework.report.design.chart.TimeChartDataSetFactory;
import no.nav.common.framework.report.design.chart.XYChartDataSetFactory;
