...
public class ErrorMonitor implements Manager {
	 ...
	 * @see no.stelvio.common.framework.monitor.Monitor#preMonitor(no.stelvio.common.framework.monitor.MonitorEvent)
	 */
	 ...
	 * @param event the event to monitor.
	 * @see no.stelvio.common.framework.monitor.Monitor#postMonitor(no.stelvio.common.framework.monitor.MonitorEvent)
	 */
