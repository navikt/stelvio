...
public abstract class AbstractServiceFacade extends SessionAdapter implements LocalService {
	 ...
	 * 
	 * {@inheritDoc}
	 * @see no.stelvio.common.framework.service.LocalService#execute(no.stelvio.common.framework.service.ServiceRequest)
	 */
	 ...
	 * 
	 * @see #execute(no.stelvio.common.framework.service.ServiceRequest)
	 */
