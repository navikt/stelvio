...
public final class DefaultMonitorImpl extends AbstractMonitor {
	...
	/**
	 * @see no.stelvio.common.framework.performance.Monitor#start(no.stelvio.common.framework.performance.MonitorKey)
	 */
	...
	/**
	 * @see no.stelvio.common.framework.performance.Monitor#fail(no.stelvio.common.framework.performance.MonitorKey)
	 */
