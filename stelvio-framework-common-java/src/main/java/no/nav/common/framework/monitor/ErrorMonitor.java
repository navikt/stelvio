...
public class ErrorMonitor implements Manager {
	 ...
	 * @see no.nav.common.framework.monitor.Monitor#preMonitor(no.nav.common.framework.monitor.MonitorEvent)
	 */
	 ...
	 * @param event the event to monitor.
	 * @see no.nav.common.framework.monitor.Monitor#postMonitor(no.nav.common.framework.monitor.MonitorEvent)
	 */
