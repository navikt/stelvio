...
import no.nav.common.framework.util.SequenceNumberGenerator;
...
public class ApplicationException extends Exception implements LoggableException {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#isLogged()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#setLogged()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getErrorId()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getUserId()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getProcessId()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getTransactionId()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getScreenId()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getErrorCode()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see no.nav.common.framework.error.LoggableException#getArguments()
	 */
