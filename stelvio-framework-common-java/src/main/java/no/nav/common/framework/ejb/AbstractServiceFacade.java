...
public abstract class AbstractServiceFacade extends SessionAdapter implements LocalService {
	 ...
	 * 
	 * {@inheritDoc}
	 * @see no.nav.common.framework.service.LocalService#execute(no.nav.common.framework.service.ServiceRequest)
	 */
	 ...
	 * 
	 * @see #execute(no.nav.common.framework.service.ServiceRequest)
	 */
