...
public final class DefaultMonitorImpl extends AbstractMonitor {
	...
	/**
	 * @see no.nav.common.framework.performance.Monitor#start(no.nav.common.framework.performance.MonitorKey)
	 */
	...
	/**
	 * @see no.nav.common.framework.performance.Monitor#end(no.nav.common.framework.performance.MonitorKey)
	 */
	...
	/**
	 * @see no.nav.common.framework.performance.Monitor#fail(no.nav.common.framework.performance.MonitorKey)
	 */
	...
	/**
	 * @see no.nav.common.framework.performance.Monitor#start(no.nav.common.framework.performance.MonitorKey, java.lang.String)
	 */
	...
	/**
	 * @see no.nav.common.framework.performance.Monitor#fail(no.nav.common.framework.performance.MonitorKey, int)
	 */
