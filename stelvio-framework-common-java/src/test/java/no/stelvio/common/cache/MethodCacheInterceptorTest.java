...
import no.stelvio.common.cache.Cache;
import no.stelvio.common.cache.MethodCacheInterceptor;
...
public class MethodCacheInterceptorTest extends MockObjectTestCase {
	...
	public void testCacheIsUsedAfterFirstCall() throws Throwable {
		mockCache.expects(once())
				.method("get")
				.with(eq("no.stelvio.common.cache.MethodCacheInterceptorTest$TestBean.testMethod.17"))
