...
import no.stelvio.common.framework.cache.Cache;
import no.stelvio.common.framework.cache.MethodCacheInterceptor;
...
public class MethodCacheInterceptorTest extends MockObjectTestCase {
	...
	public void testCacheIsUsedAfterFirstCall() throws Throwable {
		mockCache.expects(once())
				.method("get")
				.with(eq("no.stelvio.common.framework.cache.MethodCacheInterceptorTest$TestBean.testMethod.17"))
