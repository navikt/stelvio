...
import no.stelvio.common.framework.monitor.ErrorMonitorReportReceiver;
import no.stelvio.common.framework.monitor.ErrorReport;
...
public class ErrorMonitorMBeanTest extends TestCase {
	...
	public void testInit() {
		try {
			...
			assertEquals("Test 2", "no.stelvio.common.framework.monitor.ErrorMonitorReportReceiver", info.getClassName());
