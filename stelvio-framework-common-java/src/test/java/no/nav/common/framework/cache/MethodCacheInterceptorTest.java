...
import no.nav.common.framework.cache.Cache;
import no.nav.common.framework.cache.MethodCacheInterceptor;
...
public class MethodCacheInterceptorTest extends MockObjectTestCase {
	...
	public void testCacheIsUsedAfterFirstCall() throws Throwable {
		mockCache.expects(once())
				.method("get")
				.with(eq("no.nav.common.framework.cache.MethodCacheInterceptorTest$TestBean.testMethod.17"))
