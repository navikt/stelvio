...
import no.trygdeetaten.integration.framework.jms.DummyTextMessage;
...
public class XMLMessageHandlerTest extends TestCase {
	...
	public void testHandleMessage() {
		try {
			...
			classNames.put("testNestedField2", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			...
			classNames.put("testHeaderField2", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			...
			classNames.put("field1", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			classNames.put("field2", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			classNames.put("field3", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			classNames.put("field4", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			...
			classNames.put("field1[id]", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			...
			classNames = new HashMap();
			classNames.put("field1[c]", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("typedListBean[i]", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("interfaceListBean[i]", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("typedMapBean[i]", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
			...
			classNames.put("interfaceMapBean[i]", "no.trygdeetaten.integration.framework.jms.handler.TestBean");
			handler.setResponseClassNames(classNames);
			handler.setResponseFields(responseFields);
			handler.init();
