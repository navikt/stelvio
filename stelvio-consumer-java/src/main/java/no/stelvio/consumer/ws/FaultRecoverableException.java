...
public abstract class FaultRecoverableException extends FunctionalRecoverableException {
	...
	private static final Logger LOG = LoggerFactory.getLogger(FaultRecoverableException.class);
	...
	/**
	 * Creates a new instance of FaultRecoverableException.
	 *
	 * @param message
	 ...
	 *            Throwable.
	 */
	public FaultRecoverableException(String message, Throwable cause) {
		super(message, cause);
		try {
