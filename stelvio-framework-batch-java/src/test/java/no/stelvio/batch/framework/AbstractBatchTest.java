...
import no.stelvio.batch.framework.AbstractBatch;
import no.stelvio.batch.framework.BatchStatus;
...
import no.stelvio.common.framework.test.spring.hibernate.MockHibernateTemplate;
