...
public class TestT771TrekkdetaljerOutput implements Serializable {
	...
	private no.stelvio.integration.framework.stubs.TestK469Message returMelding;
	/**
	 * @return
	 */
	 ...
	 * @param message
	 */
	public void setReturMelding(no.stelvio.integration.framework.stubs.TestK469Message message) {
