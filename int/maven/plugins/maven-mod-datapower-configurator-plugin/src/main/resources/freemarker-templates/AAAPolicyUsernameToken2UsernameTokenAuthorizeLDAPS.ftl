<#macro AAAPolicyUsernameToken2UsernameTokenAuthorizeLDAPS name aaaFileName auLdapHost auLdapPort auLdapBindDN auLdapBindPwd auLdapSearchParameters auSSLProxyProfile>
