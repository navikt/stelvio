...
/**
 * Abstract class for all mojos which contains the top level executeand some
 * global maven annotation based variables used throughout the class hierarchy.
 * 
