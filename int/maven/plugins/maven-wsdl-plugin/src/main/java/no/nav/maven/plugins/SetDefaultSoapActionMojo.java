...
/**
 * Goal which sets the SOAP action in a WSDL file to the default WS-Addressing action.
 * 
 * @goal set-default-soap-action
 * @requiresDependencyResolution compile
 */
@SuppressWarnings("unchecked")
public class SetDefaultSoapActionMojo extends AbstractMojo {
