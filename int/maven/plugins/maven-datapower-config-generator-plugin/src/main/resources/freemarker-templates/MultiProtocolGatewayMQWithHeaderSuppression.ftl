<#macro MultiProtocolGatewayMQWithHeaderSuppression name mqSourceProtocolHandlerList xmlManager headerSuppressionParams backendURL propagateURI backTimeout includeResponseTypeEncoding processHTTPErrors requestType responseType stylePolicy>
