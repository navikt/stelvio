<#macro AAAPolicyUsernameToken2UsernameTokenLDAPS name aaaFileName auLdapHost auLdapPort auLdapBindDN auLdapBindPwd auLdapSearchParameters auSSLProxyProfile>
