...
public class AppServerBouncer {
	...
	/**
	 * Constructor
	 * @param mbm - reference to mojo to get Log object 
	 * @param widRuntime - parameter form settings.xml
	 * @param env - environment name
	 * @param envFilesDir - path to folder witn environment file
	 * @param restartCfgFile - path to applicationConfig.xml
...
//				getLog().info("START: wasSS>"+was_ss_operation + " wasIS>" + was_is_operation + " wps>"+wps_operation);
	...
	private final void executeCommand(Commandline command) throws MojoFailureException {
		try {
