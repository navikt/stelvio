 ...
 */
public class ApplyInheritanceMojo extends WebsphereUpdaterMojo {
	...
	protected void applyToWebSphere(Commandline wsadminCommandLine) throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			e.printStackTrace();
			throw new MojoExecutionException("Propblemer med � lese properties filer i "+ environmentPropertiesTree);
		}

		try{
			writeProps(prop, mainPropertiesFilepath);
		} catch (IOException e) {
			throw new MojoExecutionException("Propblemer med � skrive til properties filen "+ mainPropertiesFilepath, e);
		}
	}
