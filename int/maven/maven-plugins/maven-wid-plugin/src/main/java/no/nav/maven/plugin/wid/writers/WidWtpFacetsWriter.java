 ...
 * 
 * @author <a href="mailto:test@example.com">Rahul Thakur</a>
 * @author <a href="mailto:test@example.com">Fabrizio Giustina</a>
 * @version $Id$
 */
public class WidWtpFacetsWriter extends AbstractWtpResourceWriter {
	...
	/**
	 * Writes facet <code>fixed</code> element with attribute
	 * <code>facet</code> set to the value of argument <code>facetName</code>.
	 * 
	 * @param writer
	 * @param facetName
	 */
	...
	/**
	 * Writes a facet <code>installed</code> element with attribute
	 * <code>facet</code> set to the value of argument <code>facetName</code>,
	 * and attribute <code>version</code> set to the value of argument
	...
	/**
	 * Writes out any additional project facets specified in the plugin
	 * configuration
	 * 
	 * @param writer
	 * @param packaging
