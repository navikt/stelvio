...
public class SuspendAction extends AbstractReportAction {
	...
	public void setCriteria(Criteria criteria) {
		...
		//This adds a criteria to the query when SUSPEND is used, which ensures that only running process instances are returned
		this.criteria.add(Restrictions.eq("PROCESS_INSTANCE.STATE", ProcessInstanceBean.STATE_RUNNING));
	}
