...
public class MEInfo implements Comparable {
	 ...
	 * @param mBean
	 */
	public MEInfo(String name, String haGroup, String state, boolean isStarted, String process, String node, String cell,
			ObjectName mBean) {
		this.name = null;
		this.haGroup = null;
		this.state = null;
	...
	public java.lang.String toString() {
		return "MEInfo@" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this)) + ": " + "{ name=" + name
				+ ", haGroup=" + haGroup + ", state=" + state + ", process=" + process + ", node=" + node + ", bus=" + bus
				+ ", cell=" + cell + ", cluster=" + cluster + ", mBean=" + mBean + "}";
	}
