...
public class PublicationPointInfo {
	...
	public String toString() {
		return "PublicationPointInfo@" + Integer.toHexString(System.identityHashCode(this)) + ": " + "{ name="
				+ publicationPointName + ", highMessageThreshold=" + highMessageThreshold + ", sendAllowed=" + sendAllowed
				+ ", id=" + id + "}";
	}
}
