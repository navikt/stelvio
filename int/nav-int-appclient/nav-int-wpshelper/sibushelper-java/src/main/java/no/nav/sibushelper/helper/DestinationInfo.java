...
public class DestinationInfo {
     ...
     * @param targetBus
     */
    public DestinationInfo(String destinationName, String type, String description, String uuid, String targetName, String targetBus)
    {
    ...
    public String[] getQueuePoints()
    {
        ...
        arr = (String[])queuePoints.toArray(arr);
        Arrays.sort(arr);
        return arr;
    }
    ...
    public String[] getMediationPoints()
    {
        ...
        arr = (String[])mediationPoints.toArray(arr);
        Arrays.sort(arr);
        return arr;
    }
    ...
    public String[] getPublicationPoints()
    {
        ...
        arr = (String[])publicationPoints.toArray(arr);
        Arrays.sort(arr);
        return arr;
    }
    ...
    {
        return "DestinationInfo@" + Integer.toHexString(System.identityHashCode(this)) + ": {" + "destinationName=" + destinationName + ", " + "uuid=" + uuid + ", " + "description=" + description + ", " + "queuePoints=" + queuePoints + ", " + "mediationPoints=" + mediationPoints + "}";
    }    
