...
public class MQClientLinkInfo {
	...
	public String toString() {
		return "MQClientLinkInfo@" + Integer.toHexString(System.identityHashCode(this)) + ": " + "{ name=" + name + ", status="
				+ status + ", qmName=" + qmName + ", channel=" + channelName + ", defaultQM=" + defaultQM + ", mBean=" + mBean
				+ "}";
	}
