...
public class MQLinkInfo {
    ...
    {
        return "MQLinkInfo@" + Integer.toHexString(System.identityHashCode(this)) + ": " + "{ name=" + name + ", status=" + status + ", qmName=" + qmName + ", owningMEName=" + (meInfo == null ? "Unknown" : meInfo.getName()) + ", mBean=" + mBean + ", senderMBean=" + senderChannelMBean + ", receiverMBean=" + receiverChannelMBean + "}";
    }    
