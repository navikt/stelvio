...
public class QueuePointInfo {
	 ...
	 * @param id
	 */
	public QueuePointInfo(String queueName, Long queueDepth, String queueState, Long highMessageThreshold, Boolean sendAllowed,
			String id) {
		this.queueName = null;
	...
	public String toString() {
		return "QueuePointInfo@" + Integer.toHexString(System.identityHashCode(this)) + ": " + "{ name=" + queueName
				+ ", queueDepth=" + queueDepth + ", state=" + queueState + ", highMessageThreshold=" + highMessageThreshold
				+ ", sendAllowed=" + sendAllowed + ", id=" + id + "}";
	}
}
