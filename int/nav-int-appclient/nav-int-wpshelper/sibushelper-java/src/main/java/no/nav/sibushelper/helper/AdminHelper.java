...
public class AdminHelper {
     ...
     */
    public void connect(String hostName, int port, String protocol, String userName, String password, String trustStoreLocation, String trustStorePassword, String keyStoreLocation, String keyStorePassword) throws ConnectorException
    {
     ...
     * @throws ConnectorException
     */
    private Object executeCommand(AdminCommand cmd) throws CommandNotFoundException, CommandException, ConfigServiceException, ConnectorException
    {
     ...
     * @throws ConfigServiceException
     */
    private Object executeCommand(AdminCommand cmd, Session session) throws CommandNotFoundException, CommandException, ConfigServiceException
    {
     ...
     * @throws ConnectorException
     */
    public MEInfo[] getMessagingEngines() throws MalformedObjectNameException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
    {
    	...
    	for(Iterator i = sibMesSet.iterator(); i.hasNext();)
    	{
    		...
    		mes[x] = new MEInfo(meObj.getKeyProperty("name"), haGroup, state, started, meObj.getKeyProperty("process"), meObj.getKeyProperty("node"), meObj.getKeyProperty("cell"), meObj);
    		x++;
    	}
    	Arrays.sort(mes);
     ...
     * @throws ConnectorException
     */
    public List getQueuePoints(String meName) throws MalformedObjectNameException, InstanceNotFoundException, ReflectionException, ConnectorException
    {
    	...
    	Boolean sendAllowed;
    	String name;
    	for(Iterator i = queueNameSet.iterator(); i.hasNext(); queueList.add(new QueuePointInfo(name, depth, state, highMessageThreshold, sendAllowed, id)))
    	{
     ...
     * @throws ConnectorException
     */
    public QueuePointInfo getQueuePoints(String meName, String queuename) throws MalformedObjectNameException, InstanceNotFoundException, ReflectionException, ConnectorException
    {
    	logger.logp(Level.FINE, className, "getQueuePoints",  meName);
    	ObjectName queuePoints = new ObjectName("WebSphere:name=" + queuename + ",type=SIBQueuePoint" + ",SIBMessagingEngine=" + meName + ",*");
    	Set queueNameSet = ac.queryNames(queuePoints, null);
     ...
     * @throws ConnectorException
     */
    public List getMediationPoints(String meName) throws MalformedObjectNameException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
    {
    	...
    	String reason;
    	String name;
    	for(Iterator i = medPointNameSet.iterator(); i.hasNext(); medPointList.add(new MediationPointInfo(name, state, currentDepth, highMessageThreshold, sendAllowed, id, reason, obj)))
    	{
     ...
     * @throws ConnectorException
     */
    public List getPublicationPoints(String meName) throws MalformedObjectNameException, InstanceNotFoundException, ReflectionException, ConnectorException
    {
    	...
    	Boolean sendAllowed;
    	String name;
    	for(Iterator i = pubNameSet.iterator(); i.hasNext(); pubList.add(new PublicationPointInfo(name, highMessageThreshold, sendAllowed, id)))
    	{
    		ObjectName obj = (ObjectName)i.next();
     ...
     * @throws ConnectorException
     */
    public MEInfo getMEInfo(String meName) throws MalformedObjectNameException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
    {
    	...
    	String state = (String)ac.invoke(meObj, "state", null, null);
    	boolean started = ((Boolean)ac.invoke(meObj, "isStarted", null, null)).booleanValue();
    	MEInfo me = new MEInfo(meName, haGroup, state, started, meObj.getKeyProperty("process"), meObj.getKeyProperty("node"), meObj.getKeyProperty("cell"), meObj);
    ...
    public BusInfo getBusInfo(String busName) throws ConfigServiceException, ConnectorException
    {
    	...
    	AttributeList attribList = configService.getAttributes(session, bus, new String[] {"name", "description", "configurationReloadEnabled", "secure"}, false);
     ...
     */
    public void createQueue(BusMemberInfo memberInfo, String queueName) throws CommandException, ConfigServiceException, ConnectorException, CommandMgrInitException, com.ibm.websphere.management.cmdframework.CommandException
    {
     ...
     * @throws CommandMgrInitException 
     */
    public void createAliasDestination(String busName, String aliasName, String targetIdentifier, String targetBus) throws CommandException, ConfigServiceException, ConnectorException, CommandMgrInitException, com.ibm.websphere.management.cmdframework.CommandException
    {
    	logger.logp(Level.FINE, className, "createAliasDestination", (new Object[] {busName, aliasName, targetIdentifier, targetBus}).toString());
     ...
     * @throws CommandMgrInitException 
     */
    private void createDestination(BusMemberInfo memberInfo, String busName, String destName, String destType, String targetIdentifier, String targetBus) throws CommandException, ConfigServiceException, ConnectorException, CommandMgrInitException, com.ibm.websphere.management.cmdframework.CommandException
    {
    	logger.logp(Level.FINE, className, "createDestination", (new Object[] {memberInfo, busName, destName, destType, targetIdentifier, targetBus}).toString());
     ...
     * @throws com.ibm.websphere.management.cmdframework.CommandException
     */
    public void deleteDestination(String busName, String destName)  throws CommandException, ConfigServiceException, ConnectorException, CommandNotFoundException, com.ibm.websphere.management.cmdframework.CommandException
    {
     ...
     * @throws CommandMgrInitException 
     */
    public Hashtable showSIBDestination(String busName, String destName) throws CommandException, ConfigServiceException, ConnectorException, CommandMgrInitException, com.ibm.websphere.management.cmdframework.CommandException
    {
     ...
     * @throws com.ibm.websphere.management.cmdframework.CommandException
     */
    public Hashtable showSIBus(String busName) throws CommandException, ConfigServiceException, ConnectorException, CommandMgrInitException, com.ibm.websphere.management.cmdframework.CommandException
    {
	 ...
	 * @throws ConnectorException
	 */
	private Object invokeMethod(ObjectName objName, String methodName, Object params[], String signature[]) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		logger.logp(Level.FINE, className, "invokeMethod", (new Object[] {objName, methodName, params, signature}).toString());
	 ...
	 * @throws ConnectorException
	 */
	public void stopServer(ServerInfo server) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
	 ...
	 * @throws ConnectorException
	 */
	public void restartServer(ServerInfo server) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
	 ...
	 * @throws ConnectorException
	 */
	public String getServerProductDetails(ServerInfo server) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		...
		for(int x = 0; x < versionInfos.length; x++)
		{
			String productNameTag = "<product name=\"";
			int pos1 = versionInfos[x].indexOf(productNameTag);
			if(pos1 != -1)
			{
				int pos2 = versionInfos[x].indexOf("\">", pos1 + 1);
				if(pos2 != -1)
				{
					if(ret == null)
						...
						ret.append(", ");
					ret.append(versionInfos[x].substring(pos1 + productNameTag.length(), pos2));
					String levelTag = "level=\"";
					int pos3 = versionInfos[x].indexOf(levelTag);
					if(pos3 != -1)
					{
						int pos4 = versionInfos[x].indexOf("\"", pos3 + levelTag.length() + 1);
						if(pos4 != -1)
						{
							ret.append(" [");
							ret.append(versionInfos[x].substring(pos3 + levelTag.length(), pos4));
							ret.append("]");
						}
					}
				}
	 ...
	 * @throws ConnectorException
	 */
	public void dumpThreads(ServerInfo server) throws MalformedObjectNameException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		logger.logp(Level.WARNING, className, "dumpThreads", server.toString());
		ObjectName jvmObj = new ObjectName("WebSphere:type=JVM,process=" + server.getServerName() + ",node=" + server.getNodeName() + ",cell=" + server.getCellName() + ",*");
	...
	public String getTraceString(ServerInfo server)
	{
		...
		try
		{
			ObjectName traceObj = new ObjectName("WebSphere:type=TraceService,process=" + server.getServerName() + ",node=" + server.getNodeName() + ",cell=" + server.getCellName() + ",*");
	 ...
	 * @throws MalformedObjectNameException
	 */
	public void setTraceString(ServerInfo server, String traceSpec) throws InstanceNotFoundException, AttributeNotFoundException, InvalidAttributeValueException, MBeanException, ReflectionException, ConnectorException, MalformedObjectNameException
	{
	 ...
	 * @throws ReflectionException
	 */
	public ServerInfo[] getServersInfo() throws MalformedObjectNameException, NullPointerException, ConnectorException, InstanceNotFoundException, ReflectionException
	{
		logger.logp(Level.FINE, className, "getServersInfo", "Init");
        if(serverInfoCache == null) serverInfoCache = _getServersInfo();
	 ...
	 * @throws ReflectionException
	 */
	private ServerInfo[] _getServersInfo() throws MalformedObjectNameException, NullPointerException, ConnectorException, InstanceNotFoundException, ReflectionException
	{
		...
		for(Iterator i = serversObjs.iterator(); i.hasNext();)
		{
			...
			AttributeList list = ac.getAttributes(server, new String[] {"name", "pid", "cellName", "nodeName", "platformVersion", "processType"});
			servers[x] = new ServerInfo((String)((Attribute)list.get(0)).getValue(), (String)((Attribute)list.get(1)).getValue(), (String)((Attribute)list.get(2)).getValue(), (String)((Attribute)list.get(3)).getValue(), (String)((Attribute)list.get(4)).getValue(), (String)((Attribute)list.get(5)).getValue(), server);
			x++;
		}
		Arrays.sort(servers);
	 ...
	 * @throws ConnectorException
	 */
	public void createMQClientLink(String linkName, String channelName, String queueManagerName, MEInfo meInfo) throws ConfigServiceException, ConnectorException
	{
		logger.logp(Level.FINE, className, "createMQClientLink", (new Object[] {linkName, channelName, queueManagerName, meInfo}).toString());
	 ...
	 * @throws ConnectorException
	 */
	public MQClientLinkInfo[] getMQClientLinks(MEInfo meInfo) throws MalformedObjectNameException, ConfigServiceException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		...
		{
			ObjectName name = new ObjectName("WebSphere:mbeanIdentifier=" + mqClientLinkConfig[x].getKeyProperty("_Websphere_Config_Data_Id").replace('|', '/') + ",*");
			Set names = ac.queryNames(name, null);
			AttributeList attribList = configService.getAttributes(session, mqClientLinkConfig[x], new String[] {"channelName", "defaultQM"}, false);
			...
			if(names.size() != 0)
			{
				...
				links[x] = new MQClientLinkInfo(mqClientLinkMBean.getKeyProperty("name"), (String)ac.invoke(mqClientLinkMBean, "getOverallStatus", null, null), (String)ac.invoke(mqClientLinkMBean, "getQueueManagerName", null, null), channelName, defaultQM, mqClientLinkMBean);
			}
		}
	 ...
	 * @throws ConnectorException
	 */
	public MQLinkInfo[] getMQLinks(MEInfo meInfo) throws MalformedObjectNameException, ConfigServiceException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		...
		for(int x = 0; x < mqLinkConfig.length; x++)
		{
			...
			ObjectName name = new ObjectName("WebSphere:mbeanIdentifier=" + mqLinkConfig[x].getKeyProperty("_Websphere_Config_Data_Id").replace('|', '/') + ",*");
			Set names = ac.queryNames(name, null);
			if(names.size() != 0)
			{
				ObjectName mqLinkMBean = (ObjectName)names.iterator().next();
				links[x] = new MQLinkInfo(meInfo, mqLinkMBean.getKeyProperty("name"), (String)ac.invoke(mqLinkMBean, "getOverallStatus", null, null), qmName, mqLinkMBean);
			}
		}
		configService.discard(session);
	 ...
	 * @throws ConnectorException
	 */
	public Object getMQLinkChannelInfo(MQLinkInfo mqLinkInfo, String methodName, boolean senderChannel) throws MalformedObjectNameException, ConfigServiceException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
	 ...
	 * @throws ConnectorException
	 */
	private Object invokeMQLinkChannelMethod(MQLinkInfo mqLinkInfo, String methodName, boolean senderChannel, Object args[], String params[]) throws MalformedObjectNameException, ConfigServiceException, InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		...
		if(channelMBean == null)
		{
			...
			ObjectName name = new ObjectName("WebSphere:mbeanIdentifier=" + mqLinkChannelConfig[0].getKeyProperty("_Websphere_Config_Data_Id").replace('|', '/') + ",*");
			Set names = ac.queryNames(name, null);
			if(names.size() != 0)
	 ...
	 * @throws ConnectorException
	 */
	public List getMQClientLinkConnections(MQClientLinkInfo linkInfo) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
	 ...
	 * @throws ConnectorException
	 */
	public void startMQClientLink(MQClientLinkInfo link) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
	 ...
	 * @throws ConnectorException
	 */
	public void stopMQClientLink(MQClientLinkInfo link, String stopMode, String targetState) throws InstanceNotFoundException, MBeanException, ReflectionException, ConnectorException
	{
		logger.logp(Level.FINE, className, "stopMQClientLink", (new Object[] {link, stopMode, targetState}).toString());
		invokeMethod(link.getMBean(), "stopLink", new Object[] {stopMode, targetState}, new String[] {"java.lang.String", "java.lang.String"});
    ...
    {
      return "AdminHelper@" + Integer.toHexString(System.identityHashCode(this)) + "{ adminClient=" + ac + ", configService=" + configService + "}";
    }
