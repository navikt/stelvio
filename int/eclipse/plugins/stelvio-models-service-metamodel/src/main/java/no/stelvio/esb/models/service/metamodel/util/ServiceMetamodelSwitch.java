 ...
 * @generated
 */
public class ServiceMetamodelSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServiceMetamodelPackage.SERVICE_INTERFACE: {
				ServiceInterface serviceInterface = (ServiceInterface)theEObject;
				T result = caseServiceInterface(serviceInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.SERVICE_OPERATION: {
				ServiceOperation serviceOperation = (ServiceOperation)theEObject;
				T result = caseServiceOperation(serviceOperation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.FAULT: {
				Fault fault = (Fault)theEObject;
				T result = caseFault(fault);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.SERVICE_PACKAGE: {
				ServicePackage servicePackage = (ServicePackage)theEObject;
				T result = caseServicePackage(servicePackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.COMPLEX_TYPE: {
				ComplexType complexType = (ComplexType)theEObject;
				T result = caseComplexType(complexType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.OPERATION_METADATA: {
				OperationMetadata operationMetadata = (OperationMetadata)theEObject;
				T result = caseOperationMetadata(operationMetadata);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.SERVICE_CATAGORY: {
				ServiceCatagory serviceCatagory = (ServiceCatagory)theEObject;
				T result = caseServiceCatagory(serviceCatagory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.MESSAGE: {
				Message message = (Message)theEObject;
				T result = caseMessage(message);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				T result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceMetamodelPackage.ATTACHMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Package</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServicePackage(ServicePackage object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Catagory</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Catagory</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceCatagory(ServiceCatagory object) {
		return null;
	}
