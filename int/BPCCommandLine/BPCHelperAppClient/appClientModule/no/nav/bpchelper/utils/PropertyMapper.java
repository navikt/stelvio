 ...
 * <code>BFMConnectorAdapter</code><p>
 * 
 ...
 *
 * <p>For maintenance it is important to remember that the FEM Helper tool also make use 
 * of a property file on the same format</p>
 *
 * <p>NB! Since it is prefered to not perform functional validation of this properties
 * is their values used transparent here</p> 
 * 
 * @author Andreas Røe
 */
public class PropertyMapper {
	...
	public Properties getMappedProperties(Properties src) {
		...
		if (!StringUtils.isEmpty(src.getProperty(ConnectorProperties.CONNECTOR_SECURITY_ENABLED))) {
			result.setProperty(AdminClient.CONNECTOR_SECURITY_ENABLED, src.getProperty(ConnectorProperties.CONNECTOR_SECURITY_ENABLED));
		}
