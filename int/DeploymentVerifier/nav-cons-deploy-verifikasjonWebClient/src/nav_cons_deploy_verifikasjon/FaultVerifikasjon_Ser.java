...
public class FaultVerifikasjon_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public FaultVerifikasjon_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        FaultVerifikasjon bean = (FaultVerifikasjon) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_4;
          propValue = bean.getErrorMessage();
          ...
          propQName = QName_0_8;
          propValue = bean.getDateTimeStamp();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
