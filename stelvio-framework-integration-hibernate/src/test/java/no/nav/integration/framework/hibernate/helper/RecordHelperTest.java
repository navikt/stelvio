...
import no.nav.integration.framework.hibernate.mapping.Column;
import no.nav.integration.framework.hibernate.mapping.OneToMany;
...
public class RecordHelperTest extends TestCase {
	...
	public void testGetOneToMany() {
		String role = "no.nav.integration.framework.hibernate.records.Foreldre.barn";
	...
	public void testGetChildClass() {
		...
		assertEquals("no.nav.integration.framework.hibernate.records.Barn", clazz);
	}
	...
	public void testGetRoleName() {
		...
		String solution = "no.nav.integration.framework.hibernate.records.Foreldre.barn";
	...
	public void testGetRootClass() {
		...
		RootClass clazz = RecordHelper.getRootClass( config, "no.nav.integration.framework.hibernate.records.Foreldre" );
