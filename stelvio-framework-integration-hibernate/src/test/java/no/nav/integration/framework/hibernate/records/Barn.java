package no.nav.integration.framework.hibernate.records;

import org.apache.commons.lang.builder.ToStringBuilder;

import no.nav.common.framework.core.DomainObject;
...
public class Barn extends DomainObject {
    ...
    /** nullable persistent field */
    private no.nav.integration.framework.hibernate.records.Foreldre parent;

    /** full constructor */
    public Barn(String objectNr, String personId, String bidragFl, String tillBidragFl, String forskuddFl, String saerTilskFl, String samvaerKls, String innkrevFl, String belopLopBidrag, String feilPeker, no.nav.integration.framework.hibernate.records.Foreldre parent) {
    ...
    public no.nav.integration.framework.hibernate.records.Foreldre getParent() {
        return this.parent;
    }

    public void setParent(no.nav.integration.framework.hibernate.records.Foreldre parent) {
        this.parent = parent;
    }
