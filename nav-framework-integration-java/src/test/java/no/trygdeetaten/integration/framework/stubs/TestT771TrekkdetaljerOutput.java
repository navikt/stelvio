...
public class TestT771TrekkdetaljerOutput implements Serializable {
	...
	private no.trygdeetaten.integration.framework.stubs.TestK469Message returMelding;
	/**
	 * @return
	 */
	 ...
	 * @param message
	 */
	public void setReturMelding(no.trygdeetaten.integration.framework.stubs.TestK469Message message) {
