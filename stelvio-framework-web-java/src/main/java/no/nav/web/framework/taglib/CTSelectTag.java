...
import no.nav.web.framework.taglib.support.CtTagSupport;
import no.nav.web.framework.taglib.support.ExpressionEvaluator;
...
public class CTSelectTag extends SelectTag implements NestedNameSupport {
	...
	protected void prepareIndex(StringBuffer handlers, String propertyName) throws JspException {
		if (!no.nav.web.framework.taglib.support.TagSupport.prepareIndex(this, pageContext, handlers, propertyName)) {
