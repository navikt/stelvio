 ...
 * 		...
 * 		<forward name="OppretteOppgave" path="/Oppgave.do" className="no.stelvio.web.framework.action.StateAwareSessionScopeActionForward">
 * 			<set-property property="state" value="opprette"/>
 * 		</forward>
 * 		<forward name="ViseOppgave" path="/Oppgave.do" className="no.stelvio.web.framework.action.StateAwareSessionScopeActionForward">
 * 			<set-property property="state" value="vise"/>
 * 		</forward>
 * 		<forward name="EndreOppgave" path="/Oppgave.do" className="no.stelvio.web.framework.action.StateAwareSessionScopeActionForward">
