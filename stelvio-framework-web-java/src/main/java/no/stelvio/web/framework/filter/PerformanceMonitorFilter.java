package no.stelvio.web.framework.filter;
...
public final class PerformanceMonitorFilter extends AbstractFilter {
	 ...
	 * 
	 * {@inheritDoc}
	 * @see no.stelvio.web.framework.filter.AbstractFilter#doFilter(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, javax.servlet.FilterChain)
	 */
