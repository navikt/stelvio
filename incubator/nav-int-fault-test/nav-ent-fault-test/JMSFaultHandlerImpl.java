...
public class JMSFaultHandlerImpl {
	/**
	 * Default constructor.
	 */
	public JMSFaultHandlerImpl() {
		super();
	}
	...
	public String twoWay(String twoWayRequest) {
		System.out.println("Into JMSFAultHandler:twoWay");
	...
	public void oneWay(String oneWayRequest) {
		System.out.println("Into JMSFAultHandler:oneWay");
