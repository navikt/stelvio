...
<xsl:stylesheet
    ...
    xmlns:out="http://nav.no/virksomhet/tjenester/familieforhold/v1"
    xmlns:io4="http://www.ibm.com/xmlns/prod/websphere/mq/sca/6.0.0"
    xmlns:io5="http://schemas.xmlsoap.org/ws/2004/08/addressing"
    xmlns:out2="wsdl.http://nav.no/virksomhet/tjenester/familieforhold/v1"
    xmlns:out3="http://nav.no/virksomhet/tjenester/felles/v1"
    xmlns:out4="http://nav.no/virksomhet/tjenester/familieforhold/feil/v1"
    xmlns:out5="http://nav.no/virksomhet/grunnlag/familieforhold/v1"
    xmlns:io6="http://www.ibm.com/xmlns/prod/websphere/http/sca/6.1.0"
    xmlns:out6="http://nav.no/virksomhet/tjenester/familieforhold/meldinger/v1"
  ...
  <xsl:template match="io3:smo"  mode="map:hentFamilierelasjonerRequestMap">
    <io3:smo>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out2:hentFamilierelasjonerRequest'"/>
        </xsl:attribute>
        <out:hentFamilierelasjoner>
          <request>
            ...
            <!-- a simple mapping with no associated source:  to "out6:hentSamboerforhold"(boolean) -->
            <out6:hentSamboerforhold>
