...
<xsl:stylesheet
    ...
    xmlns:io4="http://nav.no/virksomhet/tjenester/familieforhold/v1"
    xmlns:io5="http://www.ibm.com/xmlns/prod/websphere/mq/sca/6.0.0"
    xmlns:io8="http://nav.no/virksomhet/tjenester/felles/v1"
    xmlns:io7="http://schemas.xmlsoap.org/ws/2004/08/addressing"
    xmlns:io6="wsdl.http://nav.no/virksomhet/tjenester/familieforhold/v1"
    xmlns:io9="http://nav.no/virksomhet/tjenester/familieforhold/feil/v1"
    xmlns:io10="http://nav.no/virksomhet/grunnlag/familieforhold/v1"
    xmlns:io11="http://www.ibm.com/xmlns/prod/websphere/http/sca/6.1.0"
    xmlns:xsd="http://www.w3.org/2001/XMLSchema"
    xmlns:io12="http://nav.no/virksomhet/tjenester/familieforhold/meldinger/v1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:HentEPSFnrListe"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:HentEPSFnrListe">
    <io3:smo>
      <context>
        <transient>
          <xsl:attribute name="xsi:type">
          ...
          <xsl:variable name="relasjoner1" select="body/io4:hentFamilierelasjonerResponse/response/person/relasjoner"/>
          <xsl:apply-templates select="$relasjoner1[contains(&apos;EKTE,REPA,SAMB&apos;,relasjonsType)]" mode="localRelasjonerToEpsFnrListe_1109016075"/>
  ...
  <xsl:template name="map:HentEPSFnrListe2">
    ...
    <context>
      <transient>
        ...
        <!-- a for-each transform: "relasjoner"(Relasjon) to "epsFnrListe"(fnrListe) -->
        <!-- variables for custom code -->
        <xsl:variable name="relasjoner1" select="$smo/body/io4:hentFamilierelasjonerResponse/response/person/relasjoner"/>
        <xsl:apply-templates select="$relasjoner1[contains(&apos;EKTE,REPA,SAMB&apos;,relasjonsType)]" mode="localRelasjonerToEpsFnrListe_1109016075"/>
  ...
  <xsl:template match="relasjoner"  mode="localRelasjonerToEpsFnrListe_1109016075">
    <epsFnrListe>
