...
import ppen015.test.bproc.nav.no.nav.inf.iverksettvedtakmicroflow.IverksettVedtakMicroflow;
...
public class SamordningStubImpl {
	 ...
	 * named "IverksettVedtakMicroflowPartner".  This will return an instance of
	 * {@link IverksettVedtakMicroflow}.  If you would like to use this service 
	 * asynchronously then you will need to cast the result
	 * to {@link IverksettVedtakMicroflowAsync}.
	 *
	 * @generated (com.ibm.wbit.java)
	 *
	 * @return IverksettVedtakMicroflow
	 */
	public IverksettVedtakMicroflow locateService_IverksettVedtakMicroflowPartner() {
		return (IverksettVedtakMicroflow) ServiceManager.INSTANCE
				.locateService("IverksettVedtakMicroflowPartner");
	}
...
//
//		locateService_IverksettVedtakMicroflowPartner().mottaSamhandlerSvar(
//				mottaSamhandler);
	}
