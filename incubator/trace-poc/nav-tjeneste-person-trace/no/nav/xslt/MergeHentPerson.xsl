...
<xsl:stylesheet
  ...
  <xsl:template match="io2:smo"  mode="map:MergeHentPerson">
    <io2:smo>
      ...
      <xsl:apply-templates select="context" mode="localContextToBody_575688775"/>
    </io2:smo>
  </xsl:template>
  ...
  <xsl:template name="map:MergeHentPerson2">
    ...
    <xsl:apply-templates select="$smo/context" mode="localContextToBody_575688775"/>
  </xsl:template>

  <!-- This rule represents an element mapping: "context" to "body".  -->
  <xsl:template match="context"  mode="localContextToBody_575688775">
    <body>
      <xsl:attribute name="xsi:type">
      ...
      <xsl:apply-templates select="shared" mode="localSharedToHentPersonResponse_227928925"/>
    </body>
  </xsl:template>

  <!-- This rule represents an element mapping: "shared" to "out2:hentPersonResponse".  -->
  <xsl:template match="shared"  mode="localSharedToHentPersonResponse_227928925">
    <out2:hentPersonResponse>
      <response>
        <person>
          <!-- a structural mapping: "person/sivilstandsInfo"(sivilstandsInfoType) to "sivilstand"(Sivilstand) -->
          <xsl:apply-templates select="person/sivilstandsInfo" mode="localSivilstandsInfoToSivilstand_1245372146"/>
          ...
          <xsl:apply-templates select="person/navn" mode="localNavnToNavn_841202161"/>
          <dodsfall>
          ...
          <xsl:apply-templates select="person/statsborgerskap" mode="localStatsborgerskapToStatsborgerskap_1486619080"/>
          <fodeland>
  ...
  <xsl:template match="navn"  mode="localNavnToNavn_841202161">
    <navn>
  ...
  <xsl:template match="statsborgerskap"  mode="localStatsborgerskapToStatsborgerskap_1486619080">
    <statsborgerskap>
  ...
  <xsl:template match="sivilstandsInfo"  mode="localSivilstandsInfoToSivilstand_1245372146">
    <sivilstand>
      <sivilstand>
