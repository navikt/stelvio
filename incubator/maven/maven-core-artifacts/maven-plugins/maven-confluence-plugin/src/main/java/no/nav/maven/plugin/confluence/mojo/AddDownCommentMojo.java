...
public class AddDownCommentMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		comment = "TEST: " + environment + " is going down for deploy of: "
				+ deployString + ", and configuration: " + configurationString;
