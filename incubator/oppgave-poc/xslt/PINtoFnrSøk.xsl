...
<!-- @generated mapFile="xslt/PINtoFnrSøk.map" md5sum="e0043e66b7ec500cb68a28bdd634a960" version="7.0.302" -->
<!--
*****************************************************************************
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/transientContext%3D%257Bhttp%253A%252F%252Foppgave-poc%257DMinIDSetWithPIN/message%3D%257Bhttp%253A%252F%252Fnav-lib-frg%252Fno%252Fnav%252Flib%252Ffrg%252Finf%252FPerson%257DfinnPersonRequestMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:map="http://oppgave-poc/xslt/PINtoFnrSøk"
  ...
  <xsl:template match="io2:smo"  mode="map:PINtoFnrSøk">
    <io2:smo>
      ...
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out3:finnPersonRequestMsg'"/>
        </xsl:attribute>
        <out2:finnPerson>
          <finnPersonRequest>
