...
<!-- @generated mapFile="xslt/PINtoFnrSøk1.map" md5sum="24138c343abf40e9982ee0d5d46814b6" version="7.0.302" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor V7.0.302
*
*   Mapping file:		PINtoFnrSøk1.map
*   Map declaration(s):	PINtoFnrSøk1
...
<xsl:stylesheet
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <dataObject>
            ...
            <xsl:call-template name="map:PINtoFnrSøk12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:PINtoFnrSøk1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:PINtoFnrSøk1">
    <io2:smo>
      <context>
  ...
  <xsl:template name="map:PINtoFnrSøk12">
    <xsl:param name="smo"/>
    <context>
