...
<!-- @generated mapFile="xslt/PersonIkkeFunnetToNavnesøk.map" md5sum="c75254fb3318dc5de8cfbde38c2f8b8d" version="7.0.302" -->
<!--
*****************************************************************************
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/transientContext%3D%257Bhttp%253A%252F%252Foppgave-poc%257DMinIDSetWithPIN/message%3D%257Bhttp%253A%252F%252Foppgave-poc%252FSED%257DvaliderOgLagreUtenlandskIdRequestMsg/xpath%3D%252F/smo.xsd
*
...
<xsl:stylesheet
  ...
  <xsl:template match="io2:smo"  mode="map:PersonIkkeFunnetToNavnesøk">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
          <xsl:value-of select="'out2:validerOgLagreUtenlandskIdRequestMsg'"/>
        </xsl:attribute>
        <out:validerOgLagreUtenlandskId>
