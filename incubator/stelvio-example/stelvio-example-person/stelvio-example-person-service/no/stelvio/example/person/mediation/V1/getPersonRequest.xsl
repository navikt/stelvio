...
<!-- @generated mapFile="no/stelvio/example/person/mediation/V1/getPersonRequest.map" md5sum="26b599157bcdf0955461e4811888b078" version="7.0.200" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
  ...
  <xsl:template match="body"  mode="map:getPersonRequest">
    <body>
      ...
      <xsl:apply-templates select="in2:getPerson" mode="localGetPersonToGetPerson_183198747"/>
    </body>
  </xsl:template>

  <!-- This rule represents an element mapping: "in2:getPerson" to "out:getPerson".  -->
  <xsl:template match="in2:getPerson"  mode="localGetPersonToGetPerson_183198747">
    <out:getPerson>
      <!-- a structural mapping: "getPersonRequest"(GetPersonRequest) to "getPersonRequest"(GetPersonRequest) -->
      <xsl:apply-templates select="getPersonRequest" mode="localGetPersonRequestToGetPersonRequest_726666098"/>
    </out:getPerson>
  </xsl:template>

  <!-- This rule represents an element mapping: "getPersonRequest" to "getPersonRequest".  -->
  <xsl:template match="getPersonRequest"  mode="localGetPersonRequestToGetPersonRequest_726666098">
    <getPersonRequest>
