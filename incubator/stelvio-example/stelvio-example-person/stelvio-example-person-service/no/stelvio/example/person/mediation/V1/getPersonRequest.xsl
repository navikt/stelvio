...
<!-- @generated mapFile="no/stelvio/example/person/mediation/V1/getPersonRequest.map" md5sum="26b599157bcdf0955461e4811888b078" version="7.0.101" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
  ...
  <xsl:template match="body"  mode="map:getPersonRequest">
    <body>
      ...
      <xsl:apply-templates select="in2:getPerson" mode="localGetPersonToGetPerson_1023972819"/>
    </body>
  </xsl:template>

  <!-- This rule represents an element mapping: "in2:getPerson" to "out:getPerson".  -->
  <xsl:template match="in2:getPerson"  mode="localGetPersonToGetPerson_1023972819">
    <out:getPerson>
      <!-- a structural mapping: "getPersonRequest"(GetPersonRequest) to "getPersonRequest"(GetPersonRequest) -->
      <xsl:apply-templates select="getPersonRequest" mode="localGetPersonRequestToGetPersonRequest_717049965"/>
    </out:getPerson>
  </xsl:template>

  <!-- This rule represents an element mapping: "getPersonRequest" to "getPersonRequest".  -->
  <xsl:template match="getPersonRequest"  mode="localGetPersonRequestToGetPersonRequest_717049965">
    <getPersonRequest>
