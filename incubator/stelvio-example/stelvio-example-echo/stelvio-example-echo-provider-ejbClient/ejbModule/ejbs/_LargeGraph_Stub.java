...
public class _LargeGraph_Stub extends Stub implements LargeGraph {
    ...
    public LGResponse echo(String arg0) throws RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    try {
                        ...
                        in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                        return (LGResponse) in.read_value(LGResponse.class);
                    } catch (ApplicationException ex) {
                        in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                        String id = in.read_string();
                        throw new UnexpectedException(id);
                ...
                ServantObject so = _servant_preinvoke("echo",ejbs.LargeGraph.class);
                if (so == null) {
                    continue;
                }
                try {
                    LGResponse result = ((ejbs.LargeGraph)so.servant).echo(arg0);
                    return (LGResponse)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                    throw Util.wrapException(exCopy);
                } finally {
