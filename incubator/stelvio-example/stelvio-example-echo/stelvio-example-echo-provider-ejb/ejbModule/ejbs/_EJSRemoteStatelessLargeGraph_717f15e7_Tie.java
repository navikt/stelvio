...
public class _EJSRemoteStatelessLargeGraph_717f15e7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessLargeGraph_717f15e7 target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:ejbs.LargeGraph:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessLargeGraph_717f15e7) target;
    }
    ...
    private OutputStream echo(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        LGResponse result = target.echo(arg0);
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
        out.write_value(result,LGResponse.class);
        return out;
    }
}
