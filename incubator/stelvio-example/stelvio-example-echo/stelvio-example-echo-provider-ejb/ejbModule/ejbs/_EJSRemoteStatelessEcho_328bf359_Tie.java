...
public class _EJSRemoteStatelessEcho_328bf359_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {
    
    private EJSRemoteStatelessEcho_328bf359 target = null;
    private ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:ejbs.Echo:0000000000000000", 
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessEcho_328bf359) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.length()) {
                case 5: 
                    if (method.equals("echo_")) {
                        return echo_(in, reply);
                    }
                case 6: 
    ...
    private OutputStream echo_(org.omg.CORBA_2_3.portable.InputStream in , ResponseHandler reply) throws Throwable {
