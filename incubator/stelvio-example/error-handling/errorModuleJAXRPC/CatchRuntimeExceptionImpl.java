...
public class CatchRuntimeExceptionImpl {
	 ...
	 * "ErrorIFPartner". This will return an instance of
	...
	/**
	 * Method generated to support implementation of operation "operation1"
	 * defined for WSDL port type named "ErrorIF".
	 * 
	 ...
	 * the operation "ErrorIF#operation1(String input1)" of wsdl interface
	 * "ErrorIF"
	 */
