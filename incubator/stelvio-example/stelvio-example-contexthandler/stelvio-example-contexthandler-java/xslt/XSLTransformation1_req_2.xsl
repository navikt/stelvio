...
<!-- @generated mapFile="xslt/XSLTransformation1_req_2.map" md5sum="ca58ee68fd12c195c88d4261992f0170" version="7.0.302" -->
<!--
*****************************************************************************
...
<xsl:stylesheet
    ...
    xmlns:map="http://stelvio-example-contexthandler-java/xslt/XSLTransformation1_req_2"
  ...
  <xsl:template match="/">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io4:smo" mode="map:XSLTransformation1_req_2"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io4:smo" to "io4:smo".  -->
  <xsl:template match="io4:smo"  mode="map:XSLTransformation1_req_2">
    <io4:smo>
