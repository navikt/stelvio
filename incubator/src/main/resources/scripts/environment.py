...
def createNameSpaceBinding ( propertyFileName ):
	...
	print '\nINFO (createNameSpaceBinding): Create Name Space Binding '+bindingId

	scopeEntry = findScopeEntry(scope, scopeName )
	
	if (scopeEntry == 0):
		print "ERROR (createNameSpaceBinding): Scope "+scopeName+" does not exist. Namespace Binding will not be created."
		return 1
	#endIf 
	...
	if (bindingType.lower() == "string"):
		...
		if (stringConf == 0):
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception creating string name space binding"
				print result
				return 1
        		#endIf 
		else:
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception modifying string name space binding"
				print result
				return 1
        		#endIf 
		#endIf
		...
		if (ejbConf == 0):
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception creating EJB name space binding"
				print result
				return 1
        		#endIf 
		else:
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception modifying EJB name space binding"
				print result
				return 1
        		#endIf 
		#endIf
		...
		if (corbaConf == 0):
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception creating CORBA Object name space binding"
				print result
				return 1
        		#endIf 
		else:
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception modifying CORBA Object name space binding"
				print result
				return 1
        		#endIf 
		#endIf
		...
		if (indConf == 0):
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception creating Indirect name space binding"
				print result
				return 1
        		#endIf 
		else:
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (createNameSpaceBinding): Caught Exception modifying Indirect name space binding"
				print result
				return 1
        		#endIf 
		#endIf
	...
	print "INFO (createNameSpaceBinding): Create/Modify of Name Space Binding "+bindingId+" was successful."
...
def deleteNameSpaceBinding ( propertyFileName ):
	...
	global AdminConfig
	print '\nINFO (deleteNameSpaceBinding): Delete Name Space Binding '+bindingId
	scopeEntry = findScopeEntry(scope, scopeName )	
	if (scopeEntry == 0):
		print "ERROR (deleteNameSpaceBinding): Scope "+scopeName+" does not exist. Namespace Binding will not be deleted."
		return 1
	#endIf 
	...
	if (bindingType.lower() == "string"):
		...
		stringConf= findConfigTargetWithScope(scope, scopeName, bindingId, "StringNameSpaceBinding")
		if (stringConf == 0):
			print "ERROR (deleteNameSpaceBinding): No Namespace Binding defined with name " +bindingId
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (deleteNameSpaceBinding): Caught Exception deleting string name space binding"
				print result
				return 1
        		#endIf 
		#endIf
		...
		if (ejbConf == 0):
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (deleteNameSpaceBinding): Caught Exception deleting EJB name space binding"
				print result
				return 1
        		#endIf 
		#endIf
		...
		if (corbaConf == 0):
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (deleteNameSpaceBinding): Caught Exception deleting CORBA Object name space binding"
				print result
				return 1
        		#endIf 
		#endIf
		...
		if (indConf == 0):
			...
			try:
        		...
        		#endTry 
			if (_excp_ ):
				print "ERROR (deleteNameSpaceBinding): Caught Exception deleting Indirect name space binding"
				print result
				return 1
        		#endIf 
		#endIf
	...
	print "INFO (deleteNameSpaceBinding): Delete of Name Space Binding "+bindingId+" was successful."
#endDef
