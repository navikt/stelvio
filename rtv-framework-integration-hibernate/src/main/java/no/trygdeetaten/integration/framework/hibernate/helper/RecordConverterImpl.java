...
import no.trygdeetaten.common.framework.util.ReflectUtil;
import no.trygdeetaten.common.framework.util.StringHelper;
...
import no.trygdeetaten.integration.framework.hibernate.mapping.OneToOne;
...
public final class RecordConverterImpl implements BeanFactoryAware, RecordConverter {
	/** Logging */
	private static final Log LOG = LogFactory.getLog("no.trygdeetaten.integration.framework.hibernate.helper.RecordConverter");
